        ...
        <div className={'md:px-40 grid md:grid-cols-4 grid-cols-3 '}>
          <div className={'md:pt-[20px] pt-[25px]'}>
            ...
            <div className={'md:hidden block'}>
              <div
                className={'col-span-1 flex md:gap-[20px] gap-[10px] px-[10px]'}
              >
                <button>
                  {' '}
                  <AiFillNotification
          ...
          <div
            className={
              'md:col-span-2 col-span-1 flex justify-center items-center md:-ml-0 -ml-[20px]'
            }
          >
          ...
          <div
            className={
              'col-span-1 flex md:gap-[20px] gap-[5px] md:px-[30px] px-[10px]  justify-end items-center'
            }
          >
            <div className={'col-span-1 md:pt-[0px] pt-[20px]'}>
              <span
                className={'font-semibold text-blue-950 md:text-base text-xs'}
              >
                {' '}
                Nusky Ansar
              </span>
            ...
            <div className={'col-span-1 rounded-full md:pt-[10px] pt-[20px]'}>
              <img
                className={
                  'md:h-[60px] md:w-[60px] h-[50px] w-[55px] rounded-full'
                }
                src={Profile}
                alt="Logo"
              />
